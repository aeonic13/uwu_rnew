...
CREATE TABLE "propManager" (
    ...
    CONSTRAINT "propManager_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "propManager_email_key" ON "propManager"("email");
...
-- AddForeignKey
ALTER TABLE "Listing" ADD CONSTRAINT "Listing_propManagerId_fkey" FOREIGN KEY ("propManagerId") REFERENCES "propManager"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
