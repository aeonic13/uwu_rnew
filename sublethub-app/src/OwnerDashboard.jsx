...
import { 
  Building2, DollarSign, Users, Calendar, FileText, Settings, AlertTriangle, 
  TrendingUp, Mail, Phone, MapPin, Star, Shield, Clock, CheckCircle, 
  XCircle, Plus, Edit, Trash2, Download, Upload, Eye, Search, Filter,
  Home, Wrench, Zap, Droplets, Wifi, Car, PieChart, BarChart3,
  CreditCard, Receipt, BellRing, MessageSquare, Camera, ArrowRight,
  Target, Award, ThumbsUp, AlertCircle, Activity
} from 'lucide-react';
...
const OwnerDashboard = ({ user, onBack, onNavigate }) => {
    ...
    maintenanceRequests: [
      {
        ...
        estimatedCost: 150,
        description: 'Water is slowly dripping from the kitchen faucet. Tenant reports it started 3 days ago.',
        photos: ['https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=300']
      },
      {
        id: 'maint-2',
    ...
    applications: [
      {
        ...
        pets: 'None',
        references: [
          { name: 'Dr. Sarah Smith', relation: 'Professor', phone: '(555) 111-2222' },
          { name: 'John Davis', relation: 'Previous Landlord', phone: '(555) 333-4444' }
        ]
      }
    ],
    financials: {
      ...
      upcomingPayments: [
        { description: 'Property Insurance', amount: 1200, dueDate: '2024-04-01' },
        { description: 'Property Tax Q1', amount: 3500, dueDate: '2024-04-15' },
        { description: 'Landscaping Service', amount: 400, dueDate: '2024-03-30' }
      ]
    },
    analytics: {
      occupancyTrend: [
  ...
  return (
    <div className="p-4 pb-20">
      <div className="mb-6">
        <h2 className="text-2xl font-bold mb-2">Property Management Dashboard</h2>
        <div className="flex items-center text-gray-600">
          <Building2 size={16} className="mr-2" />
          <span>{dashboardData.overview.totalProperties} Properties • {dashboardData.overview.totalUnits} Units</span>
        </div>
      </div>

      {/* Tab Navigation */}
      <div className="flex mb-6 bg-gray-100 rounded-lg p-1 overflow-x-auto">
        {['overview', 'properties', 'tenants', 'applications', 'maintenance', 'financials', 'analytics'].map((tab) => (
          <button
            key={tab}
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-green-50 p-4 rounded-lg border border-green-200">
              <div className="flex items-center justify-between mb-2">
                <div className="text-2xl font-bold text-green-600">${dashboardData.overview.monthlyRevenue.toLocaleString()}</div>
            ...
            <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
              <div className="flex items-center justify-between mb-2">
                <div className="text-2xl font-bold text-yellow-600">{dashboardData.overview.maintenanceRequests}</div>
                <Wrench size={20} className="text-yellow-600" />
              </div>
              <div className="text-sm text-yellow-700">Active Requests</div>
              <div className="text-xs text-yellow-600 mt-1">2 high priority</div>
            </div>

            <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
              <div className="flex items-center justify-between mb-2">
                <div className="text-2xl font-bold text-purple-600">{dashboardData.overview.pendingApplications}</div>
                <FileText size={20} className="text-purple-600" />
              </div>
              <div className="text-sm text-purple-700">Pending Applications</div>
            ...
            <div className="grid grid-cols-1 gap-3">
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-600">{dashboardData.overview.pendingApplications} pending review</p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-600">{dashboardData.overview.maintenanceRequests} active requests</p>
                  </div>
                </div>
                <ArrowRight size={16} className="text-gray-400" />
              </button>
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-600">${dashboardData.overview.securityDepositsHeld.toLocaleString()} held in escrow</p>
                  </div>
                </div>
                <ArrowRight size={16} className="text-gray-400" />
              </button>
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-600">Automated rent collection with 91% success rate</p>
                  </div>
                </div>
                <ArrowRight size={16} className="text-gray-400" />
              </button>
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-600">Schedule E & 1099 forms ready</p>
                  </div>
                </div>
                <ArrowRight size={16} className="text-gray-400" />
              </button>
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="text-left">
                    <p className="font-medium">Sublease Approvals</p>
                    <p className="text-sm text-gray-600">2 requests pending your approval</p>
                  </div>
                </div>
                <ArrowRight size={16} className="text-gray-400" />
              </button>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium">Rent payment received - Alex Johnson</p>
              ...
              <div className="flex items-center">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium">New application received - Emma Wilson</p>
              ...
              <div className="flex items-center">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium">Maintenance request - Kitchen faucet leak</p>
                  <p className="text-xs text-gray-500">1 day ago • Unit 3A assigned to Mike's Plumbing</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-red-50 border border-red-200 rounded-lg p-4">
            ...
            <div className="space-y-2">
              <p className="text-sm text-red-700">• 1 tenant is overdue on rent payment ($2,200)</p>
              <p className="text-sm text-red-700">• 1 high-priority maintenance request needs immediate attention</p>
              <p className="text-sm text-red-700">• Property insurance expires in 90 days</p>
            </div>
          </div>
        </div>
      )}
              ...
              <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    <div className="flex items-center mb-2">
                      <h4 className="font-semibold text-lg mr-2">{property.name}</h4>
                    ...
                    <div className="text-sm text-gray-600">
                      {property.type} • Built {property.yearBuilt} • {property.squareFeet.toLocaleString()} sq ft
                    </div>
                  </div>
                  <img
                    src={property.image}
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-500">Avg: ${property.avgRent}/unit</div>
                  </div>
                </div>
          ...
          {dashboardData.tenants.map((tenant) => (
            <div key={tenant.id} className="bg-white border border-gray-200 rounded-lg p-6">
              <div className="flex items-start justify-between mb-4">
                ...
                <span className={`px-3 py-1 text-sm rounded-full ${getStatusColor(tenant.status)}`}>
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                ...
                <div>
                  ...
                  <div className="font-semibold text-green-600">{tenant.creditScore}</div>
                </div>
                <div>
                  <div className="text-sm text-gray-600">Last Payment</div>
                  <div className="font-semibold">{new Date(tenant.lastPayment).toLocaleDateString()}</div>
                </div>
              </div>
            ...
            <div key={app.id} className="bg-white border border-gray-200 rounded-lg p-6">
              <div className="flex items-start justify-between mb-4">
                <div>
                  ...
                  <div className="text-sm text-gray-600">{app.university} Student • {app.year}</div>
                  <div className="flex items-center mt-1">
                    <Mail size={14} className="text-gray-400 mr-1" />
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                ...
                <div>
                  ...
                  <div className="font-semibold">{new Date(app.desiredMoveIn).toLocaleDateString()}</div>
                </div>
                <div>
                  <div className="text-sm text-gray-600">Offered Rent</div>
                  <div className="font-semibold text-green-600">${app.rentOffered}</div>
                </div>
                <div>
                  <div className="text-sm text-gray-600">Credit Score</div>
                  <div className="font-semibold text-green-600">{app.creditScore}</div>
                </div>
              </div>
              ...
              <div className="mb-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {app.documents.map((doc, index) => (
                    <span key={index} className="px-2 py-1 bg-green-100 text-green-700 text-xs rounded flex items-center">
              ...
              <div className="mb-4">
                ...
                {app.references.map((ref, index) => (
                  <div key={index} className="text-sm mb-1">
                    <span className="font-medium">{ref.name}</span> - {ref.relation} • {ref.phone}
                  </div>
                ))}
              </div>
      ...
      {activeTab === 'financials' && (
        <div className="space-y-6">
              ...
              {dashboardData.financials.monthlyBreakdown.map((month, index) => (
                <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div>
                    ...
                    <div className="text-sm text-gray-600">
                      Revenue: ${month.revenue.toLocaleString()} • Expenses: ${month.expenses.toLocaleString()}
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="font-semibold text-green-600">${month.netIncome.toLocaleString()}</div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <div className="space-y-3">
              {dashboardData.financials.upcomingPayments.map((payment, index) => (
                <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div>
                    <div className="font-medium">{payment.description}</div>
                    <div className="text-sm text-gray-600">Due: {new Date(payment.dueDate).toLocaleDateString()}</div>
                  </div>
                  <div className="text-right">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  ...
                  <span className="font-semibold text-green-600">8.2 months</span>
                </div>
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                ...
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  ...
                  <span className="font-semibold text-orange-600">2.1 days</span>
                </div>
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
