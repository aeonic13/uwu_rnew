...
const SubleaseContractManager = ({ user, currentLease, onBack, onNavigate }) => {
  const [activeTab, setActiveTab] = useState('overview');
  const [showCreateContract, setShowCreateContract] = useState(false);
  const [selectedContract, setSelectedContract] = useState(null);
  const [contractForm, setContractForm] = useState({
    subletType: 'room', // room, entire-unit, shared-space
    startDate: '',
    endDate: '',
    monthlyRent: '',
    securityDeposit: '',
  ...
  // Mock data for sublease contracts
  const [contractData] = useState({
    ...
    contracts: [
      {
        ...
        documents: [
          { type: 'contract', url: '/docs/sublease-001.pdf', generated: '2024-02-15' },
      ...
      },
      {
        ...
        documents: [
          { type: 'contract_draft', url: '/docs/sublease-002-draft.pdf', generated: '2024-03-20' }
        ],
    ...
    templates: [
      {
        id: 'standard-room',
        name: 'Standard Room Sublease',
        description: 'Basic agreement for subletting a private room',
        popularity: 95,
      ...
      },
      {
        ...
        description: 'For subletting part of a room or shared living space',
        popularity: 78,
      ...
      {
        id: 'short-term',
        name: 'Short-term Sublease',
        description: 'For subletting periods under 3 months',
        popularity: 65,
  ...
  const handleCreateContract = () => {
    try {
      ...
      logSecurityEvent('contract_created', {
        user: userIdentifier,
        contractType: contractForm.subletType,
    ...
    alert(
      'Sublease contract created successfully!\n\n' +
      'Next steps:\n' +
      '1. Your landlord will be notified and must approve this sublease\n' +
  ...
  return (
    <div className="p-4 pb-20">
      <div className="mb-6">
        <h2 className="text-2xl font-bold mb-2">Sublease Contract Manager</h2>
        <div className="flex items-center text-gray-600">
          <FileText size={16} className="mr-2" />
          <span>Create and manage legal subletting agreements</span>
        </div>
      </div>
      ...
      {activeTab === 'overview' && (
        <div className="space-y-6">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <h3 className="font-semibold mb-4">Your Subletting Eligibility</h3>
            ...
            <div className="mt-4 p-3 bg-blue-50 rounded-lg">
              <p className="text-sm text-blue-700">
                <strong>Note:</strong> Your landlord's approval is required before any sublease can become active. 
          ...
          {/* Quick Stats */}
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <h3 className="font-semibold mb-4">Subletting Overview</h3>
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="text-left">
                    <p className="font-medium">Create New Sublease</p>
                    <p className="text-sm text-gray-600">Start a new subletting agreement</p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-600">Know your state's subletting laws</p>
                  </div>
                </div>
                <ChevronRight size={16} className="text-gray-400" />
              </button>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-500">Sublease-001 • 1 week ago</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {activeTab === 'contracts' && (
        <div className="space-y-4">
          <div className="flex justify-between items-center">
            <h3 className="font-semibold">Your Sublease Contracts</h3>
            <button
              onClick={() => setActiveTab('create')}
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-sm text-gray-600 capitalize">{contract.type} sublease</p>
      ...
      {activeTab === 'create' && (
        <div className="space-y-6">
          <h3 className="font-semibold">Create New Sublease Contract</h3>

          {/* Contract Type Selection */}
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <h4 className="font-semibold mb-4">What are you subletting?</h4>
            <div className="grid grid-cols-1 gap-3">
              {[
                { type: 'room', title: 'Private Room', desc: 'Subletting your private bedroom', icon: Home },
                { type: 'entire-unit', title: 'Entire Unit', desc: 'Subletting your whole apartment/unit', icon: Building },
          ...
          {/* Sublease Duration */}
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <h4 className="font-semibold mb-4">Sublease Duration</h4>
            <div className="grid grid-cols-2 gap-4">
              <div>
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-yellow-700">
                  Subletting laws vary by state and local jurisdiction. Always ensure you have written permission 
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <div className="text-sm text-gray-600">Max Sublet Duration</div>
                <div className="font-semibold">{contractData.legalRequirements.maxSubletDuration}</div>
              </div>
              <div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div className="flex items-start">
              ...
              <div>
                <h4 className="font-semibold text-blue-800 mb-2">SubletHub Legal Protection</h4>
                <p className="text-sm text-blue-700 mb-3">
                  All contracts generated through SubletHub are automatically updated to comply with current 
...
export default SubleaseContractManager;