...
const LEASE_TEMPLATES = {
  ...
  sublease: {
    ...
    description: 'Student-to-student subletting with master lease connection',
    scenario: 'sublease',
...
const LegalTemplateSystem = ({ property, application, onGenerateAgreement, onBack }) => {
  const [selectedTemplate, setSelectedTemplate] = useState('sublease');
    ...
    <div className="p-4 pb-20">
      ...
      {stateLaws && selectedTemplate && (
        <div className="mb-6">
          <h3 className="font-semibold mb-3 flex items-center">
            ...
            {LEASE_TEMPLATES[selectedTemplate].scenario === 'sublease' ? 'Subletting Provisions' :
      ...
      <div className="mb-6">
        ...
        <div className="space-y-4">
          ...
          {selectedTemplate === 'sublease' && (
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <h4 className="font-semibold text-yellow-800 mb-3">Subletting Details</h4>
              <div className="space-y-3">
                <div>
