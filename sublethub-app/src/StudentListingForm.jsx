...
const StudentListingForm = ({ onSubmit, onBack, currentUser }) => {
  ...
  const [listingData, setListingData] = useState({
    ...
    availableFrom: '',
    availableTo: '',
    propertyType: 'room', // Default to room since students often sublet their room
    bedrooms: 1,
    bathrooms: 1,
    amenities: [],
    reasonForSubletting: '',
  ...
  if (currentStep === 1) {
    return (
      <div className="p-6 pb-20">
        <div className="mb-6">
          <h2 className="text-2xl font-bold mb-2">Sublet Your Space</h2>
          <p className="text-gray-600">
            List your room or property for subletting. We'll get approval from your property owner first.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium mb-2">What are you subletting?</label>
              <select
          ...
          <div>
            <label className="block text-sm font-medium mb-2">Why are you subletting?</label>
            <select
              value={listingData.reasonForSubletting}
              onChange={(e) => setListingData(prev => ({ ...prev, reasonForSubletting: e.target.value }))}
              className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
              <option value="">Select reason</option>
              {sublettingReasons.map(reason => (
        ...
        <div className="flex space-x-3 mt-8">
          ...
          <button
            ...
            disabled={!listingData.title || !listingData.address || !listingData.reasonForSubletting}
            className={`flex-1 py-3 rounded-lg font-semibold ${
              listingData.title && listingData.address && listingData.reasonForSubletting
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-sm text-yellow-700">
                We need to verify with your property owner/landlord that you have permission to sublet. This protects both you and potential renters.
              </p>
            </div>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
              ...
              <p className="text-sm text-gray-500 mt-1">
                This helps verify your right to sublet
              </p>
            </div>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Any other important information subletter should know..."
              rows={3}
              className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
      ...
      <div className="p-6 pb-20">
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
          ...
          <ul className="text-sm text-yellow-700 space-y-1">
            ...
            <li>• You are responsible for coordinating move-in/move-out with the subletter</li>
            <li>• SubletHub will handle payments and provide protection for all parties</li>
          </ul>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
          ...
          <div className="text-sm text-blue-700 space-y-2">
            <p>• Create a legally binding sublease contract to protect yourself and your sublessee</p>
            <p>• Set up payment collection and security deposit management</p>
            <p>• Screen potential sublessees with our verification tools</p>
          </div>
          <button
            onClick={() => {
              // This would navigate to the sublease contract manager
              alert('After submitting, you can create a sublease contract in your profile under "Student Features"');
            }}
            className="mt-3 text-blue-600 hover:text-blue-700 text-sm font-medium flex items-center"
          >
            <FileText size={16} className="mr-1" />
            Learn about sublease contracts →
          </button>
        </div>
