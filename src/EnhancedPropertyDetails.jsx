...
const EnhancedPropertyDetails = ({
  ...
  const totalUtilityCost = Object.values(utilityCosts).reduce(
    (sum, utility) => sum + utility.avg,
    0
  )
  ...
  const amenityCategories = {
    Essential: [
      {
        name: 'WiFi',
        icon: Wifi,
        available: listing.amenities.includes('WiFi'),
      },
      {
        name: 'Laundry',
        icon: Home,
    ...
    Comfort: [
      ...
      },
      {
        name: 'AC',
        icon: Thermometer,
        available: listing.amenities.includes('AC'),
      },
      {
        name: 'Study Space',
        icon: Home,
        available: listing.amenities.includes('Study Space'),
      },
      {
        name: 'Balcony',
        icon: Home,
        available: listing.amenities.includes('Balcony'),
      },
    ],
    Community: [
      {
        name: 'Gym',
        icon: Users,
        available: listing.amenities.includes('Gym'),
      },
      {
        name: 'Pool',
        icon: Droplets,
        available: listing.amenities.includes('Pool'),
      },
      {
        name: 'Garden',
        icon: Home,
        available: listing.amenities.includes('Garden'),
      },
      {
        name: 'Pet-friendly',
        icon: Heart,
        available: listing.amenities.includes('Pet-friendly'),
      },
    ],
  }
        ...
        <div className="mb-6">
          ...
          <div className="bg-gray-50 rounded-lg p-4">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center">
                      <div
                        className={`p-2 rounded-full bg-${data.color}-100 mr-3`}
                      >
                        <IconComponent
                          size={16}
            ...
            <p className="text-xs text-gray-600 mt-2">
              *Estimates based on average usage in the area. Actual costs may
              vary.
            </p>
          </div>
        </div>
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center mb-2">
                ...
                <span className="text-gray-500 ml-1">
                  ({listing.owner.reviewCount || 12} reviews)
                </span>
              </div>
