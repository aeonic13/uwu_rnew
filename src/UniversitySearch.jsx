...
const UniversitySearch = ({ onBack, onSelectListing }) => {
  ...
  const filteredListings = useMemo(() => {
    ...
    return sampleListingsWithCoords
      .filter(listing => {
      ...
      <div className="p-4 pb-20">
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            Search for your university and discover nearby rentalting options
          </p>
        </div>
              ...
              <div className="p-4">
                ...
                <div className="flex flex-wrap gap-1 mb-3">
                  {listing.amenities.slice(0, 3).map(amenity => (
                    <span
                      key={amenity}
                      className="px-2 py-1 bg-brand-100 text-blue-800 rounded-full text-xs"
                    >
                      {amenity}
                    </span>
                  ))}
