...
const MessagesList = ({ conversations, onSelectConversation, currentUser }) => {
        ...
        {filteredConversations.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full px-4 text-center">
            ...
            <p className="text-gray-500 text-sm">
              Start browsing properties and send messages to property owners to
              ...
              >
                ...
                <div className="flex-1 ml-3 min-w-0">
                  <div className="flex items-center justify-between mb-1">
                    <h3
                      className={`font-medium text-sm truncate ${isUnread ? 'text-gray-900' : 'text-gray-700'}`}
                    >
                      {conversation.property.title}
                    </h3>
                    <div className="flex items-center space-x-1.5">
                      ...
                      {conversation.tourScheduled ? (
                        ...
                        <div
                          className="flex items-center justify-center w-5 h-5 bg-gray-100 rounded-full"
                          title="No tour scheduled"
                        >
                      ...
                      <span
                        className={`text-xs ${isUnread ? 'text-brand-500 font-medium' : 'text-gray-500'}`}
                      >
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1 min-w-0">
                      <p className={`text-xs text-gray-500 mb-1 truncate`}>
                        ${conversation.property.price}/mo •{' '}
                        {conversation.property.location}
                      </p>
                      <p
          ...
          <p className="text-xs text-gray-500 text-center">
            {
              filteredConversations.filter(
                conv =>
                  ...
                  conv.lastMessage.sender !== currentUser.id
              ).length
            }{' '}
