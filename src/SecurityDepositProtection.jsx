...
const SecurityDepositProtection = ({ user, onBack, onNavigate }) => {
    ...
    deposits: [
      {
        ...
        inspections: {
          moveIn: {
            ...
            issues: [
              {
                item: 'Small scuff on wall',
                room: 'Living Room',
                severity: 'minor',
                documented: true,
              },
              {
                item: 'Loose cabinet door',
                room: 'Kitchen',
                severity: 'minor',
                documented: true,
              },
        ...
        timeline: [
          {
            date: '2023-08-15',
            event: 'Security deposit paid to escrow',
            status: 'completed',
          },
          {
            date: '2023-08-30',
          ...
          {
            date: '2024-05-31',
            event: 'Automatic deposit return',
            status: 'upcoming',
          },
        ],
      },
  ...
  const getStatusIcon = status => {
    switch (status) {
      ...
      case 'pending_return':
        return <RefreshCw className="text-brand-500" size={16} />
      case 'returned':
  ...
  const handleNewEscrow = () => {
    ...
    alert(
      'Escrow account created successfully! Your security deposit is now protected and earning interest.'
    )
  }
  ...
  const handleClaimDeposit = () => {
    ...
    alert(
      'Deposit return initiated! Funds will be transferred to your account within 2-3 business days.'
    )
  }
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center">
                <div className="text-2xl font-bold text-green-600">
                  {formatCurrency(depositData.user.totalProtected)}
                </div>
                <div className="text-sm text-gray-600">Total Protected</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-brand-500">
                  {depositData.user.activeDeposits}
                </div>
                <div className="text-sm text-gray-600">Active Deposits</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-purple-600">
                  {depositData.statistics.averageReturnRate}%
                </div>
                <div className="text-sm text-gray-600">Return Rate</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-orange-600">
                  {depositData.user.protectionRating}
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-600">
                      Secure your next security deposit in escrow
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-600">
                      {depositData.user.activeDeposits} deposits currently
                      protected
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-600">
                      Process automatic or manual deposit returns
                    </p>
                  </div>
                </div>
                <ArrowRight size={16} className="text-gray-400" />
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-600">
                      Learn about coverage and guarantees
                    </p>
                  </div>
                </div>
                <ArrowRight size={16} className="text-gray-400" />
                ...
                <div className="flex items-start justify-between mb-2">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        {formatCurrency(deposit.deposit.amount)} • Escrow #
                        {deposit.escrowId}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center">
                    ...
                    <span
                      className={`ml-2 px-2 py-1 text-xs rounded-full ${getStatusColor(deposit.status)}`}
                    >
                ...
                <div className="grid grid-cols-2 gap-4 text-sm mt-3">
                  ...
                  <div>
                    ...
                    <span className="ml-2 font-medium text-green-600">
                      {formatCurrency(deposit.escrow.interestEarned)}
                    </span>
                  </div>
                  <div>
                    <span className="text-gray-600">Days Remaining:</span>
                    <span className="ml-2 font-medium">
                      {deposit.deposit.daysRemaining} days
                    </span>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            ...
            <div className="text-sm text-green-700 space-y-2">
              <p>
                ...
                {depositData.statistics.averageReturnRate}% average return rate
                with full documentation
              </p>
              <p>
                • <strong>Earn Interest:</strong> Your deposit earns 2.5% APY
                while in secure escrow
              </p>
              <p>
                • <strong>Legal Protection:</strong> Full dispute resolution and
                legal support included
              </p>
              <p>
                • <strong>Fast Returns:</strong> Average return time of{' '}
                {depositData.statistics.averageReturnTime}
              </p>
              <p>
                • <strong>Photo Documentation:</strong> Professional
            ...
            <div className="grid grid-cols-2 gap-4 text-center">
              <div>
                <div className="text-lg font-bold text-brand-500">
                  {formatCurrency(
                    depositData.statistics.totalDepositsProtected
                  )}
                </div>
              ...
              <div>
                <div className="text-lg font-bold text-green-600">
                  {depositData.statistics.protectionSuccess}%
                </div>
                <div className="text-xs text-gray-600">Success Rate</div>
              </div>
              <div>
                <div className="text-lg font-bold text-purple-600">
                  {formatCurrency(depositData.statistics.totalSaved)}
                </div>
                <div className="text-xs text-gray-600">Total Saved</div>
              </div>
              <div>
                <div className="text-lg font-bold text-orange-600">
                  {depositData.statistics.customerSatisfaction}
                </div>
                ...
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        {deposit.property.type} • {deposit.property.bedrooms}{' '}
                        bed, {deposit.property.bathrooms} bath
                      </p>
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-lg font-bold text-green-600 mt-1">
                      {formatCurrency(deposit.deposit.amount)}
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 text-sm mb-3">
                  <div>
                    ...
                    <div className="text-xs text-gray-500">
                      {deposit.landlord.company}
                    </div>
                  </div>
                  <div>
                    <span className="text-gray-600">Lease Period:</span>
                    <div className="font-medium">
                      {new Date(deposit.lease.startDate).toLocaleDateString()} -{' '}
                ...
                <div className="bg-green-50 p-3 rounded-lg mb-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-medium text-green-700">
                      {deposit.protection.guaranteedReturn}% Guaranteed Return
                    </span>
                  </div>
                </div>
                ...
                <div className="mb-3">
                  <div className="flex items-center justify-between text-sm mb-2">
                    ...
                    <span className="text-gray-600">
                      {deposit.deposit.daysRemaining} days remaining
                    </span>
                  </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            {depositData.deposits
              .filter(d => d.deposit.daysRemaining <= 60)
              .map(deposit => (
                <div
                  key={deposit.id}
                  className="border border-gray-200 rounded-lg p-4 mb-4"
                  ...
                  <div className="bg-brand-50 p-3 rounded-lg mb-3">
                    <div className="text-sm">
                      ...
                      <div className="text-brand-600">
                        Your deposit will be automatically returned 3 days after
                        lease end unless disputed by landlord
                      </div>
                    </div>
                  </div>
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      Processing time: {deposit.returnTime}
                    </p>
                  </div>
                  <div className="text-right">
                    <div className="text-lg font-bold text-green-600">
                      {formatCurrency(deposit.deposit.returnedAmount)}
                    </div>
                    <div className="text-sm text-gray-600">
                      of {formatCurrency(deposit.deposit.amount)}
                    </div>
                  </div>
                </div>
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Your entire security deposit is held in FDIC-insured escrow
                    accounts
                  </p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Earn 2.5% APY on your deposit while it's in escrow
                  </p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Professional mediation for any deposit disputes with
                    landlords
                  </p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Access to legal experts for complex deposit issues
                  </p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Professional move-in/move-out inspections with photo
                    documentation
                  </p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    85-90% guaranteed return rate with full protection coverage
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Choose a trusted escrow provider and set up your secure
                    account
                  </p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Your security deposit is held safely in escrow and starts
                    earning interest
                  </p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Document property condition at move-in and move-out with
                    photos
                  </p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Receive your deposit + interest automatically within 3 days
                    of lease end
                  </p>
                </div>
              </div>
          ...
          <div className="bg-brand-50 border border-brand-200 rounded-lg p-4">
            ...
            <div className="space-y-3 text-sm text-brand-600">
              <div>
                <p>
                  <strong>Sarah M., USC Student:</strong> "Got my full $2,200
                  deposit back plus $48 in interest. The documentation photos
                  saved me when my landlord tried to claim damage that wasn't
                  there."
                </p>
              </div>
              <div>
                <p>
                  <strong>Mike T., UCLA Student:</strong> "The dispute
                  resolution service was amazing. They helped me get back $400
                  that my landlord was wrongfully withholding for 'cleaning
                  fees.'"
                </p>
              </div>
              <div>
                <p>
                  <strong>Jessica L., Berkeley Student:</strong> "Automatic
                  return was so convenient. Got my money back the day after my
                  lease ended without having to chase my landlord."
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <p className="text-xs text-gray-600 mb-3">
                    Schedule a professional move-in inspection to document
                    property condition
                  </p>
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  ...
                  <div className="text-sm text-green-700 space-y-1">
                    ...
                    <div className="flex justify-between font-medium">
                      ...
                      <span>
                        +$
                        {newEscrowForm.depositAmount
                          ? (newEscrowForm.depositAmount * 0.025).toFixed(0)
                          : '0'}
                        /year
                      </span>
                    </div>
              ...
              <div className="flex space-x-3 mt-6">
                ...
                <button
                  ...
                  disabled={
                    !newEscrowForm.propertyAddress ||
                    !newEscrowForm.depositAmount ||
                    !newEscrowForm.landlordEmail
                  }
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="text-sm space-y-1">
                    <div>
                      ...
                      {selectedDeposit.property.address}
                    </div>
                    <div>
                      <strong>Deposit Amount:</strong>{' '}
                      {formatCurrency(selectedDeposit.deposit.amount)}
                    </div>
                    <div>
                      <strong>Interest Earned:</strong>{' '}
                      {formatCurrency(selectedDeposit.escrow.interestEarned)}
                    </div>
                    <div>
                      <strong>Total Return:</strong>{' '}
                      {formatCurrency(
                        selectedDeposit.deposit.amount +
                          selectedDeposit.escrow.interestEarned
                      )}
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-brand-50 border border-brand-200 rounded-lg p-4">
                  ...
                  <div className="text-sm text-brand-600 space-y-1">
                    <p>
                      • Move-out inspection will be scheduled within 48 hours
                    </p>
                    <p>• Landlord has 7 days to dispute any charges</p>
                    <p>
                      • Funds will be released to your account within 2-3
                      business days
                    </p>
                    <p>
                      • You'll receive full documentation of the return process
                    </p>
                  </div>
                </div>
                ...
                <div>
                  <label className="block text-sm font-medium mb-2">
                    Bank Account for Deposit Return
                  </label>
