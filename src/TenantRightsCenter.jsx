...
const TENANT_RIGHTS_BY_STATE = {
  CA: {
    ...
    commonIssues: [
      {
        ...
        yourRights:
          'Landlord must give 24-hour written notice except for emergencies',
        action:
          'Document violations, send written notice to landlord, contact local tenant organization',
      },
      {
        issue: 'Security deposit not returned',
        yourRights:
          'Full deposit must be returned within 21 days, with itemized deductions if any',
        action:
          'Send demand letter, file in small claims court for up to 2x deposit + court costs',
      },
      {
        issue: 'Rent increase seems too high',
        yourRights:
          'Increases limited to 5% + local inflation rate (max 10%) annually',
        action:
          'Check if property is exempt, verify proper 30-day notice was given',
      },
      {
        issue: 'Repair issues ignored',
        yourRights:
          'Landlord must maintain habitability; you can withhold rent or repair and deduct',
        action:
          'Written notice to landlord, wait reasonable time, then pursue legal remedies',
      },
    ],
    studentSpecific: [
    ...
    resources: [
      ...
      {
        name: 'Tenants Together (Statewide)',
        url: 'https://tenantstogether.org/',
        phone: '(415) 495-8100',
      },
      {
        name: 'Los Angeles Tenants Union',
        url: 'https://latenantsunion.org/',
        phone: '(213) 387-8829',
      },
      {
  ...
  NY: {
    ...
    commonIssues: [
      {
        ...
        yourRights:
          'Landlord must provide heat (68°F day, 62°F night) and hot water',
        action:
          'Contact NYC 311, document temperature readings, may withhold rent',
      },
      {
        issue: 'Illegal rent increase',
        yourRights:
          'Rent stabilized apartments have legal increase limits set annually',
        action:
          'Check DHCR records for apartment status, file complaint if stabilized',
      },
      {
        issue: 'Landlord harassment',
        yourRights:
          'Protected against intentional interruption of services or privacy violations',
        action:
          'Document incidents, file complaint with HPD, contact tenant organizations',
      },
      {
        issue: 'Security deposit issues',
        yourRights:
          'Cannot exceed 1 month rent, must be held in separate account',
        action:
          'Demand return within reasonable time, sue in small claims court',
      },
    ],
    studentSpecific: [
    ...
    resources: [
      {
        name: 'NYC Department of Housing (HPD)',
        url: 'https://www1.nyc.gov/site/hpd/',
        phone: '311',
      },
      {
        name: 'Met Council on Housing',
        url: 'https://www.metcouncilonhousing.org/',
        phone: '(212) 979-0611',
      },
      {
        name: 'Housing Rights Initiative',
        url: 'https://www.housingrightsny.org/',
        phone: '(212) 689-7962',
      },
      {
  ...
  TX: {
    ...
    commonIssues: [
      {
        ...
        action:
          'Written notice to landlord, document temperatures, may justify lease termination',
      },
      {
        issue: 'Security deposit kept unfairly',
        yourRights:
          'Must receive deposit back within 30 days with itemized deductions',
        action:
          'Send written demand, file in small claims court for up to 3x deposit amount',
      },
      {
        issue: 'Eviction notice received',
        yourRights:
          'Must receive proper notice period and opportunity to cure lease violations',
      ...
      },
      {
        ...
        action:
          'Written notice, allow reasonable time, may terminate lease for serious issues',
      },
    ],
    studentSpecific: [
    ...
    resources: [
      {
        name: 'Texas Department of Housing',
        url: 'https://www.tdhca.state.tx.us/',
        phone: '(512) 475-3800',
      },
      {
        name: "Texas Tenants' Union",
        url: 'https://txtenants.org/',
        phone: '(713) 686-6693',
      },
      {
  ...
  FL: {
    ...
    commonIssues: [
      {
        ...
        yourRights:
          'Landlord must address conditions affecting health and safety',
        action:
          'Document with photos, written notice to landlord, may withhold rent',
      },
      {
        issue: 'Hurricane damage repairs',
        yourRights:
          'Landlord must make reasonable efforts to restore habitability',
        action:
          'Document damage, written notice, understand lease may be terminated',
      },
      {
        issue: 'Security deposit disputes',
        yourRights:
          'Deposits must be returned within 15 days or notice of deductions within 30 days',
        action:
          'Written demand, small claims court for damages plus court costs',
      },
      {
        issue: 'Rent increase without notice',
        yourRights:
          'Month-to-month tenancies require 15 days notice for rent increases',
        action:
          'Check lease terms for notice requirements, document improper notice',
      },
    ],
    studentSpecific: [
    ...
    resources: [
      {
        name: 'Florida Department of Agriculture (Landlord-Tenant Law)',
...
const TenantRightsCenter = ({ userState = 'CA', onBack }) => {
  ...
  const stateData =
    TENANT_RIGHTS_BY_STATE[selectedState] || TENANT_RIGHTS_BY_STATE['CA']
    ...
    <div className="p-4 pb-20">
      <div className="mb-6">
        <h2 className="text-2xl font-bold mb-2">
          Tenant Rights Education Center
        </h2>
        <p className="text-gray-600">
          Know your rights and protect yourself as a student renter
        </p>
      </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-red-50 border border-red-200 rounded-lg p-4">
            ...
            <p className="text-sm text-red-700 mb-3">
              If you're facing eviction, harassment, or unsafe conditions, get
              help immediately:
            </p>
        ...
        <div className="space-y-4">
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
            ...
            <p className="text-sm text-green-700">
              These rights are protected by {stateData.name} law and cannot be
              waived by lease agreements.
            </p>
          </div>
            ...
            >
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div
                    className={`transform transition-transform ${selectedIssue === index ? 'rotate-180' : ''}`}
                  >
                    ▼
                  </div>
                </div>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-500 text-center">
                Available for Rentra users • Response within 24 hours
              </p>
            </div>
          </div>
        </div>
