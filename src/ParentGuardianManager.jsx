...
const ParentGuardianManager = ({ user, onBack, onNavigate }) => {
  ...
  const handleAddParent = () => {
    ...
    alert(
      'Parent invitation sent! They will receive an email to set up their account.'
    )
  }
  ...
  const getRelationshipIcon = relationship => {
    switch (relationship) {
      case 'father':
        return <User size={20} className="text-brand-500" />
      case 'mother':
  ...
  return (
    <div className="p-4 pb-20">
      ...
      <div className="flex mb-6 bg-gray-100 rounded-lg p-1 overflow-x-auto">
        {['overview', 'parents', 'payments', 'settings', 'notifications'].map(
          tab => (
            <button
              key={tab}
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <div className="text-xs text-gray-500">
                  {parentData.student.university}
                </div>
              </div>
              <div>
                <div className="text-sm text-gray-600">Current Rent</div>
                <div className="font-semibold text-green-600">
                  ${parentData.student.currentLease.monthlyRent}/month
                </div>
                <div className="text-xs text-gray-500">
                  Due {parentData.student.currentLease.dueDate}
                </div>
              </div>
              <div>
                <div className="text-sm text-gray-600">Parents/Guardians</div>
                <div className="font-semibold">
                  {parentData.summary.totalParents} active
                </div>
                <div className="text-xs text-gray-500">
                  {parentData.summary.activePaymentMethods} payment method
                </div>
              </div>
              <div>
                <div className="text-sm text-gray-600">Payment History</div>
                <div className="font-semibold text-brand-500">
                  {parentData.summary.onTimeRate}% on-time
                </div>
                <div className="text-xs text-gray-500">
                  ${parentData.summary.totalPaid.toLocaleString()} total paid
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-600">
                      Invite family member to help with rent
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-600">
                      All family payments and receipts
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-600">
                      Configure permissions and notifications
                    </p>
                  </div>
                </div>
              ...
              {parentData.parents.map(parent => (
                ...
                >
                  ...
                  <div className="text-right">
                    <span
                      className={`px-2 py-1 text-xs rounded-full ${getStatusColor(parent.status)}`}
                    >
                      {parent.status}
                    </span>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium">
                    March rent payment completed
                  </p>
                  <p className="text-xs text-gray-500">
                    Paid by Robert Johnson • 2 hours ago
                  </p>
                </div>
              ...
              <div className="flex items-center">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium">
                    Rent reminder sent to family
                  </p>
                  <p className="text-xs text-gray-500">
                    April rent due in 5 days • 1 day ago
                  </p>
                </div>
              </div>
              <div className="flex items-center">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium">
                    Linda Johnson joined family account
                  </p>
                  <p className="text-xs text-gray-500">
                    Added as emergency contact • 2 months ago
                  </p>
                </div>
              </div>
            </div>
            ...
            >
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <div className="flex items-center">
                      ...
                      <span
                        className={`ml-2 px-2 py-1 text-xs rounded-full ${getStatusColor(parent.status)}`}
                      >
                        {parent.status}
                      </span>
                    </div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                  ...
                  <div className="font-semibold text-green-600">
                    ${parent.totalPaid.toLocaleString()}
                  </div>
                </div>
                <div>
                  <div className="text-sm text-gray-600">Payment Methods</div>
                  <div className="font-semibold">
                    {parent.paymentMethods.length}
                  </div>
                </div>
                <div>
                  <div className="text-sm text-gray-600">On-Time Payments</div>
                  <div className="font-semibold text-brand-500">
                    {parent.onTimePayments}
                  </div>
                </div>
                <div>
                  <div className="text-sm text-gray-600">Added</div>
                  <div className="font-semibold">
                    {new Date(parent.addedDate).toLocaleDateString()}
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="text-center">
                <div className="text-xl font-bold text-green-600">
                  ${parentData.summary.totalPaid.toLocaleString()}
                </div>
                <div className="text-sm text-gray-600">Total Paid</div>
              </div>
              <div className="text-center">
                <div className="text-xl font-bold text-brand-500">
                  {parentData.summary.onTimeRate}%
                </div>
                <div className="text-sm text-gray-600">On-Time Rate</div>
              </div>
              <div className="text-center">
                <div className="text-xl font-bold text-purple-600">
                  {parentData.summary.avgPaymentTime}
                </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
                    checked={parentData.familySettings.autoPayEnabled}
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Send updates to all family members
                  </p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
                    checked={parentData.familySettings.familyNotifications}
                    className="sr-only peer"
                    readOnly
                  />
                  <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-brand-500"></div>
              ...
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Student can override family payment settings
                  </p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
                    checked={parentData.familySettings.studentOverride}
                    className="sr-only peer"
                    readOnly
                  />
                  <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-brand-500"></div>
                      ...
                      <input
                        ...
                        onChange={e =>
                          setParentForm(prev => ({
                            ...
                            permissions: {
                              ...prev.permissions,
                              viewRentDetails: e.target.checked,
                            },
                          }))
                        }
                        className="mr-2"
