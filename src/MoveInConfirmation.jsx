      ...
      <div className="p-6 pb-20">
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            Take photos to document the property's condition. This protects both
        ...
        <div className="bg-gray-50 rounded-lg p-4 mb-6">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-sm text-gray-600">
              {
                Object.values(confirmationData.utilitiesSetup).filter(Boolean)
                  .length
              }{' '}
    ...
    return (
      <div className="p-6 pb-20">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Your move-in has been confirmed. We'll release the security deposit
            to your landlord.
          </p>
        </div>
        ...
        <div className="bg-brand-50 border border-brand-200 rounded-lg p-4 mb-6">
          ...
          <p className="text-sm text-brand-600">
            Your security deposit and first month's rent have been released to
            the landlord. Future rent payments will be due on the 1st of each
            month.
          </p>
        </div>
          ...
          <div className="space-y-3">
            <div className="flex items-start">
              ...
              <span className="text-sm">
                We'll send you monthly rent reminders
              </span>
            </div>
            <div className="flex items-start">
              <div className="bg-brand-100 rounded-full p-1 mr-3 mt-1">
              ...
              <span className="text-sm">
                Your photos are saved for security deposit protection
              </span>
            </div>
            <div className="flex items-start">
              <div className="bg-brand-100 rounded-full p-1 mr-3 mt-1">
