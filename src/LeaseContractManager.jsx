...
const LeaseContractManager = ({ user, currentLease, onBack, onNavigate }) => {
    ...
    contracts: [
      {
        ...
        documents: [
          {
            type: 'contract',
            url: '/docs/lease-001.pdf',
            generated: '2024-02-15',
          },
          {
            type: 'id_verification',
            url: '/docs/maria-id.pdf',
            uploaded: '2024-02-14',
          },
        ],
  ...
  const getStatusIcon = status => {
    switch (status) {
      ...
      case 'pending_signatures':
        return <PenTool size={16} className="text-brand-500" />
      case 'expired':
  ...
  const handleCreateContract = () => {
    ...
    const newContract = {
      ...
      status: contractForm.ownerApprovalRequired
        ? 'pending_approval'
        : 'pending_signatures',
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <div className="mt-4 p-3 bg-brand-50 rounded-lg">
              <p className="text-sm text-brand-600">
                <strong>Note:</strong> Your landlord's approval is required
                before any lease can become active. We'll handle the approval
                request process for you.
              </p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <div className="font-semibold">
                  {contractData.student.currentLease.property}
                </div>
              </div>
              <div>
                <div className="text-sm text-gray-600">Monthly Rent</div>
                <div className="font-semibold">
                  ${contractData.student.currentLease.rentAmount}
                </div>
              </div>
              <div>
                <div className="text-sm text-gray-600">Lease End Date</div>
                <div className="font-semibold">
                  {contractData.student.currentLease.leaseEndDate}
                </div>
              </div>
              <div>
                <div className="text-sm text-gray-600">Landlord</div>
                <div className="font-semibold">
                  {contractData.student.currentLease.landlord}
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center">
                <div className="text-2xl font-bold text-brand-500">
                  {contractData.analytics.totalContracts}
                </div>
                <div className="text-sm text-gray-600">Total Contracts</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-green-600">
                  {contractData.analytics.activeContracts}
                </div>
                <div className="text-sm text-gray-600">Active Now</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-purple-600">
                  ${contractData.analytics.totalIncome}
                </div>
                <div className="text-sm text-gray-600">Total Income</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-orange-600">
                  {contractData.analytics.occupancyRate}%
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-600">
                      Start a new rentalting agreement
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-600">
                      View and edit existing agreements
                    </p>
                  </div>
                </div>
                <ChevronRight size={16} className="text-gray-400" />
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-600">
                      Know your state's rentalting laws
                    </p>
                  </div>
                </div>
                <ChevronRight size={16} className="text-gray-400" />
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium">
                    New contract created for James Park
                  </p>
                  <p className="text-xs text-gray-500">
                    Pending approval • 1 day ago
                  </p>
                </div>
              </div>
              <div className="flex items-center">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium">
                    Contract signed by Maria Rodriguez
                  </p>
                  <p className="text-xs text-gray-500">
                    Lease-001 • 1 week ago
                  </p>
                </div>
              </div>
            </div>
                  ...
                  <div className="ml-3">
                    <div className="flex items-center">
                      <h4 className="font-semibold mr-2">
                        {contract.sublessee.name}
                      </h4>
                      <span
                        className={`px-2 py-1 text-xs rounded-full ${getStatusColor(contract.status)}`}
                      >
                    ...
                    <p className="text-xs text-gray-500">
                      {contract.sublessee.email}
                    </p>
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-lg font-semibold text-green-600">
                    ${contract.terms.monthlyRent}/month
                  </div>
                ...
                <div>
                  ...
                  <div
                    className={`font-semibold ${
                      contract.payments.currentMonthPaid
                        ? 'text-green-600'
                        : 'text-red-600'
                    }`}
                  >
        ...
        <div className="space-y-6">
              ...
              {[
                {
                  type: 'room',
                  title: 'Private Room',
                  desc: 'Rentalting your private bedroom',
                  icon: Home,
                },
                {
                  type: 'entire-unit',
                  title: 'Entire Unit',
                  desc: 'Rentalting your whole apartment/unit',
                  icon: Building,
                },
                {
                  type: 'shared-space',
                  title: 'Shared Space',
                  desc: 'Sharing part of your room or common area',
                  icon: Users,
                },
                ...
                <button
                  key={type}
                  onClick={() =>
                    setContractForm(prev => ({ ...prev, rentalType: type }))
                  }
          ...
          <div className="flex space-x-3">
            ...
            <button
              ...
              disabled={
                !contractForm.sublessee.name ||
                !contractForm.sublessee.email ||
      ...
      {activeTab === 'legal' && (
        <div className="space-y-6">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-yellow-700">
                  Rentalting laws vary by state and local jurisdiction. Always
                  ensure you have written permission from your landlord and
                  comply with your original lease terms.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <div className="space-y-3">
              {contractData.legalRequirements.requiredDisclosures.map(
                (disclosure, index) => (
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <div className="space-y-3">
              {contractData.legalRequirements.mandatoryClauses.map(
                (clause, index) => (
                  <div key={index} className="flex items-start">
                    <Scale
                      size={16}
                      className="text-brand-500 mr-3 flex-shrink-0 mt-0.5"
                    />
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <div className="font-semibold">
                  {contractData.legalRequirements.ownerApprovalRequired
                    ? 'Required'
                    : 'Not Required'}
                </div>
              </div>
              <div>
                ...
                <div className="font-semibold">
                  {contractData.legalRequirements.maxRentalDuration}
                </div>
              </div>
              <div>
                ...
                <div className="font-semibold">
                  {contractData.legalRequirements.securityDepositLimit}
                </div>
              </div>
              <div>
                <div className="text-sm text-gray-600">State</div>
                <div className="font-semibold">
                  {contractData.legalRequirements.state}
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                <h4 className="font-semibold text-blue-800 mb-2">
                  Rentra Legal Protection
                </h4>
                <p className="text-sm text-brand-600 mb-3">
                  All contracts generated through Rentra are automatically
                  updated to comply with current state and local laws. Our legal
                  AI ensures your agreements are enforceable and protect both
                  parties.
                </p>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <div className="font-semibold">
                        {selectedContract.sublessee.name}
                      </div>
                    </div>
                    <div>
                      <div className="text-sm text-gray-600">Status</div>
                      <span
                        className={`inline-block px-2 py-1 text-xs rounded-full ${getStatusColor(selectedContract.status)}`}
                      >
                    ...
                    <div>
                      <div className="text-sm text-gray-600">Monthly Rent</div>
                      <div className="font-semibold">
                        ${selectedContract.terms.monthlyRent}
                      </div>
                    </div>
                    <div>
                      <div className="text-sm text-gray-600">Duration</div>
                      <div className="font-semibold">
                        {selectedContract.terms.startDate} to{' '}
                        {selectedContract.terms.endDate}
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <div
                        className={`font-semibold ${
                          selectedContract.payments.securityDepositPaid
                            ? 'text-green-600'
                            : 'text-red-600'
                        }`}
                      >
                    ...
                    <div>
                      ...
                      <div
                        className={`font-semibold ${
                          selectedContract.payments.currentMonthPaid
                            ? 'text-green-600'
                            : 'text-red-600'
                        }`}
                      >
                    ...
                    <div>
                      ...
                      <div className="font-semibold">
                        ${selectedContract.payments.totalReceived}
                      </div>
                    </div>
                    <div>
                      <div className="text-sm text-gray-600">Next Due</div>
