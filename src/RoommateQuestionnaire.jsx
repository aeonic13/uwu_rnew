...
const RoommateQuestionnaire = ({ onComplete, onBack, existingAnswers = null }) => {
      ...
      questions: [
        {
          ...
          options: [
            ...
            { value: 'eventually', label: 'Pay when we get around to them', weight: 1 }
          ]
        },
        {
          id: 'utilities',
          ...
          options: [
            ...
            { value: 'separate', label: 'Separate utility expenses (e.g. One pays hydro, one pays internet)', weight: 1 }
          ]
        },
        {
          id: 'borrowing',
          ...
          type: 'single',
          options: [
            { value: 'shareEverything', label: "Let's share everything - no need to ask", weight: 4 },
            { value: 'askFirst', label: 'You can probably borrow my stuff - just ask first', weight: 3 },
            { value: 'emergencyOnly', label: "I won't say no in an emergency (I prefer to not share)", weight: 2 },
            { value: 'neverLend', label: "Sorry, I don't ever lend my stuff to others", weight: 1 }
          ]
        },
        {
          id: 'commonItems',
          ...
          options: [
            ...
            { value: 'buyOwn', label: 'Buy our own items separately', weight: 1 }
          ]
        },
        {
          id: 'foodSharing',
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          type: 'single',
          options: [
            { value: 'sparklingClean', label: 'Always sparkling clean', weight: 4 },
        ...
        },
        {
          ...
          type: 'single',
          options: [
            { value: 'spotless', label: 'Spotlessly clean - daily tidy', weight: 4 },
            { value: 'weekly', label: 'Pretty good - weekly clean', weight: 3 },
            { value: 'monthly', label: 'Not bad - monthly clean', weight: 2 },
            { value: 'never', label: 'Not sure - no cleaning products', weight: 1 }
          ]
        },
        {
          id: 'dishes',
          ...
          options: [
            ...
            { value: 'morningSoak', label: 'Wash in morning after overnight soak', weight: 2 },
            { value: 'whenDirty', label: 'Wash only when everything else is dirty', weight: 1 }
          ]
        },
        {
          id: 'cleaningSchedule',
          ...
          options: [
            ...
            { value: 'permanent', label: 'Permanent cleaning assignment', weight: 2 },
            { value: 'asNeeded', label: 'Decide when need for cleaning arises', weight: 1 }
          ]
        },
        {
      ...
      questions: [
        {
          ...
          options: [
            ...
            { value: 'notInHouse', label: 'Yes, but not in the house', weight: 2 },
      ...
      questions: [
        {
          ...
          options: [
            ...
            { value: 'dayEvening', label: 'During the day and evening, but not at night', weight: 3 },
            { value: 'daytimeOnly', label: 'During the daytime only please', weight: 2 },
            { value: 'library', label: 'I need the silence of a library', weight: 1 }
          ]
        },
        {
          id: 'musicFrequency',
        ...
        },
        {
          ...
          options: [
            ...
            { value: 'comfortable', label: 'Comfortable listening level', weight: 3 },
            { value: 'background', label: 'Quiet, background level', weight: 2 },
        ...
        },
        {
          ...
          options: [
            ...
            { value: 'moderate', label: 'Moderate: between 11pm - 1am', weight: 2 },
        ...
        },
        {
          ...
          options: [
            ...
            { value: 'someDistractions', label: 'Some distractions are ok', weight: 2 },
      ...
      questions: [
        {
          ...
          type: 'single',
          options: [
            { value: 'allTheTime', label: 'The more the merrier! Guests all the time', weight: 5 },
            { value: 'headsUp', label: 'Not a problem, just ask for a heads up', weight: 4 },
            { value: 'occasionally', label: 'One or two guests are okay occasionally', weight: 3 },
            { value: 'rare', label: 'On a rare occasion guests are fine', weight: 2 },
            { value: 'noGuests', label: 'I prefer no guests coming over', weight: 1 }
          ]
        },
        {
          id: 'overnightGuests',
          ...
          options: [
            ...
            { value: 'occasionally', label: 'Occasionally is fine, but not multiple nights', weight: 3 },
            { value: 'regularly', label: 'Guests staying over regularly is fine', weight: 4 },
            { value: 'notComfortable', label: "I'm not comfortable with guests staying over", weight: 1 }
          ]
        },
        {
          id: 'parties',
          ...
          type: 'single',
          options: [
            { value: 'loveThem', label: "Love them, I'd host every week if I could!", weight: 4 },
            { value: 'withNotice', label: "They're fine, just provide notice ahead of time", weight: 3 },
            { value: 'smallGathering', label: 'An occasional dinner/small gathering is fine', weight: 2 },
            { value: 'noParties', label: "I don't want to have any parties at my home", weight: 1 }
          ]
        },
        {
          id: 'frequentGuests',
          ...
          type: 'single',
          options: [
            { value: 'frequent', label: 'I have a guest who will stay over frequently (3+ x/week)', weight: 3 },
            { value: 'occasional', label: 'I have a guest who will stay over occasionally (<3x)', weight: 2 },
            { value: 'none', label: 'I do not anticipate any guests staying over', weight: 1 }
          ]
        }
      ]
    },
      ...
      questions: [
        {
          ...
          type: 'multiple',
          options: [
            { value: 'vegMeatOk', label: "I'm vegetarian/vegan but meat can be in the house" },
            { value: 'vegNoMeat', label: "I'm vegetarian/vegan and meat can't be in the house" },
        ...
        },
        {
          ...
          type: 'single',
          options: [
            { value: 'allMeals', label: 'All three meals, most days', weight: 4 },
            { value: 'dinners', label: 'Usually dinners', weight: 3 },
            { value: 'bigMeals', label: 'One or two big meals a week', weight: 2 },
        ...
        },
        {
          ...
          type: 'single',
          options: [
            { value: 'weekdays', label: "I'm game for drinks during the week", weight: 4 },
            { value: 'weekends', label: 'I save it for the weekends', weight: 3 },
            { value: 'occasionally', label: 'I drink a few times a month', weight: 2 },
            { value: 'noDrinkOkWithIt', label: "I don't drink, but I don't mind if you do", weight: 2 },
            { value: 'alcoholFree', label: "I don't drink, and I'd like an alcohol-free home", weight: 1 }
          ]
        }
      ]
    },
      ...
      questions: [
        {
          ...
          type: 'single',
          options: [
            { value: 'billsChores', label: 'Someone to split the bills and chores', weight: 1 },
            { value: 'friendly', label: "Someone friendly, but don't have to be best friends", weight: 2 },
            { value: 'hangOut', label: 'Someone who wants to hang out and do stuff with', weight: 3 }
          ]
        },
        {
