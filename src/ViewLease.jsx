...
import { ArrowLeft, FileText, Download, Mail, Phone, Calendar, DollarSign, Home, User, Shield, AlertCircle, Check } from 'lucide-react';
...
const ViewLeaseView = ({ user, lease, onBack }) => {
  ...
  const leaseDetails = {
    ...
    status: 'active',
    property: {
      address: lease?.property?.address || '123 University Ave, Los Angeles, CA 90007',
    ...
    payments: [
      ...
      { date: '2024-01-01', amount: 1200, type: 'security_deposit', status: 'paid' },
    ...
    <div className="p-4 pb-20">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-4 mb-6">
        <div className="flex items-center justify-between mb-3">
          ...
          <div className={`px-3 py-1 rounded-full text-sm font-medium border ${getStatusColor(leaseDetails.status)}`}>
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          <div>
            ...
            <p className="font-semibold">
              {formatDate(leaseDetails.terms.startDate)} - {formatDate(leaseDetails.terms.endDate)}
            </p>
          </div>
          <div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <div className="grid grid-cols-1 gap-3 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-medium text-right">{leaseDetails.property.address}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Type</span>
                <span className="font-medium">{leaseDetails.property.type}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Size</span>
                <span className="font-medium">{leaseDetails.property.sqft} sq ft</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Bedrooms/Bathrooms</span>
                <span className="font-medium">{leaseDetails.property.bedrooms}BR / {leaseDetails.property.bathrooms}BA</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <div className="space-y-2 text-sm">
              <p><span className="font-medium">{leaseDetails.landlord.name}</span></p>
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div>
                <p className="font-medium text-orange-600 mb-1">Your Responsibility:</p>
                <div className="space-y-1">
                  {leaseDetails.utilities.notIncluded.map((utility, index) => (
                    <div key={index} className="flex justify-between">
                      <span>{utility}</span>
                      <span className="text-gray-600">
                        ~${utility === 'Electricity' ? leaseDetails.utilities.electricityEstimate : 
                           utility === 'Gas' ? leaseDetails.utilities.gasEstimate :
                           utility === 'Internet' ? leaseDetails.utilities.internetEstimate : '?'}/month
                      </span>
                    </div>
                  ))}
                </div>
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <div className="grid grid-cols-1 gap-3 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-semibold text-green-600">${leaseDetails.terms.monthlyRent}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Security Deposit</span>
                <span className="font-medium">${leaseDetails.terms.securityDeposit}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Late Fee</span>
                <span className="font-medium">${leaseDetails.terms.lateFee} (after {leaseDetails.terms.gracePeriod} days)</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Early Termination Fee</span>
                <span className="font-medium">${leaseDetails.terms.earlyTerminationFee}</span>
              </div>
            </div>
          </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      {document.type.toUpperCase()} • {formatDate(document.date)}
                    </p>
                  </div>
                </div>
                <button
