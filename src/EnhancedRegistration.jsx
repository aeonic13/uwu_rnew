...
const EnhancedRegistration = ({ onComplete }) => {
  ...
  const handleComplete = async () => {
    ...
    if (listerType === 'property-owner') {
      ...
      userIntent === 'looking-to-rent' ||
      listerType === 'student-lease'
    ) {
      ...
      <div className="max-w-md mx-auto bg-white min-h-screen flex flex-col justify-center p-6">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Connect with fellow students for safe rentalting
          </p>
        </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    I'm a student searching for a place to live
                  </p>
                </div>
              </div>
            </button>
            ...
            >
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    I want to list my property or find someone to lease
                  </p>
                </div>
              </div>
            </button>
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h3 className="font-semibold text-lg">
                    Student Looking to Lease
                  </h3>
                  <p className="text-sm text-gray-600 mt-1">
                    I'm a student who needs someone to take over my lease
                  </p>
                </div>
              </div>
            </button>
            ...
            >
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    I own property and want to rent to students
                  </p>
                </div>
              </div>
            </button>
          ...
          <div className="flex items-center mb-4 p-4 bg-brand-50 rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm text-brand-500">
                We verify all student renters with their .edu email
              </p>
            </div>
          </div>
            ...
            {isStudentLister && (
              <div className="flex items-center mb-4 p-4 bg-brand-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-brand-500">
                    Students must verify with their .edu email
                  </p>
                </div>
              </div>
            )}
      ...
      <div className="max-w-md mx-auto bg-white min-h-screen p-6">
        ...
        <div className="mb-6 text-center">
          ...
          <p className="text-sm text-gray-600 mt-2">
            Add a friendly photo to your profile
          </p>
        </div>
      ...
      return (
        <div className="max-w-md mx-auto bg-white min-h-screen flex flex-col justify-center p-6">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              You're all set up as a property owner
            </p>
          </div>
    ...
    return (
      <div className="max-w-md mx-auto bg-white min-h-screen p-6">
          ...
          <div className="flex items-start">
            ...
            <div className="flex-1">
              <h3 className="font-semibold text-green-800 mb-2">
                Recommended: Quick Pre-Approval
              </h3>
              <p className="text-sm text-green-700 mb-4">
                To streamline the renting process and have a faster, more
                convenient time, we recommend you apply through our partner{' '}
                <strong>"RentSpree"</strong> and set up your credit check, so
                owners can have quick access.
              </p>
        ...
        <div className="space-y-4 mb-8">
          <button
            onClick={() =>
              setFormData(prev => ({ ...prev, wantsCreditCheck: true }))
            }
            ...
            <div className="flex items-center">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600">
                  Get verified and stand out to landlords
                </p>
              </div>
              {formData.wantsCreditCheck && (
          ...
          <button
            onClick={() =>
              setFormData(prev => ({ ...prev, wantsCreditCheck: false }))
            }
            className={`w-full p-4 border-2 rounded-lg text-left transition-colors ${
              !formData.wantsCreditCheck
          ...
          >
            <div className="flex items-center">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600">
                  I'll do this when I'm ready to apply
                </p>
              </div>
              {!formData.wantsCreditCheck && (
        ...
        <div className="bg-brand-50 border border-brand-200 rounded-lg p-4 mb-6">
          <p className="text-sm text-brand-600">
            <strong>Note:</strong> In the meantime, feel free to save places and
            begin messaging with property owners. You can complete verification
